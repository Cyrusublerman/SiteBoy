...
20 rules in this category.

## labelling-A51B905B

**MUST:** Place user notes above AI interpretation in the note body order.

*User intent at capture time often outweighs machine-extracted content.*
...
**MUST:** Indicate the information source used to calculate any summary statistics.

*Source attribution lets viewers verify figures and assess credibility.*
...
**MUST:** Map AI tag suggestions back to the controlled registry before storage.

*Suggested tags must resolve to canonical registry entries, not freeform strings.*
...
**MUST:** Keep AI captions separate from controlled tags.

*Captions are descriptive prose and must not pollute the tag registry.*
...
**MUST:** Store inline manual notes verbatim from the --note flag.

*Preserves exact user wording without paraphrase or cleanup at capture time.*
...
*Attribution helps viewers find the original source when graphics are reposted unattributed.*
...
**SHOULD:** Apply classification tags to captured notes.

*Tags enable routing and retrieval across library areas and pipelines.*
...
**SHOULD:** Support attached notes and extra instructions on diagram captures.

*Attached context preserves author intent that pure geometry cannot encode.*
