...
---
id: composition-FF7F57D4
schema_version: 1.0.0
category: composition
modality: SHOULD
statement: Maintain a simple, consistent style for all graphical elements.
rationale: Unified aesthetics make an infographic feel cohesive and visually pleasing.
scope: 
  - data-viz
applies_to: []
excludes: []
