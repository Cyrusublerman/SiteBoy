...
- [ ] Replace process-local login rate limiting with distributed enforcement.
...
- 2026-07-18: the current login-attempt limiter is still process-local and is not a sufficient production defence by itself.
