...
|---|----------|--------|----------|
| 1.1 | What does this module do? | Sharpens the image via unsharp mask — subtracts a blurred version to enhance edges | — |
| 1.2 | Visually distinct from all other SHARPEN modules? | YES — unsharp mask is distinct from high pass | — |
| 1.3 | Verdict | KEEP | — |
