...
|---|----------|--------|----------|
| 1.1 | What does this module do? | Applies affine transformation — moves and translates the image with edge stretching | — |
| 1.2 | Visually distinct from all other TRANSFORM modules? | YES — only module in TRANSFORM category | — |
| 1.3 | Verdict | KEEP | — |
