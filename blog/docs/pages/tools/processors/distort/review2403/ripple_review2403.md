...
|---|----------|--------|----------|
| 1.1 | What does this module do? | Applies a ripple/wave distortion to the image | — |
| 1.2 | Visually distinct from all other REFRACTION modules? | YES — ripple wave distortion is distinct from lens bubble refraction | — |
| 1.3 | Verdict | KEEP | — |
