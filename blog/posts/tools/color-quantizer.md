...
High-fidelity image quantization with custom color palettes and advanced dithering.

## High-Fidelity Image Quantization Tool

<div id="color-quantizer-tool-container" style="
    border: var(--outline-width) solid var(--c-border);
    padding: 20px;
    margin: 20px 0;
    background: var(--c-bg);
">
    <div id="color-quantizer-tool-content">
        <h3>High-Fidelity Image Quantization</h3>
        
        <div id="color-quantizer-controls">
            ...
            <div class="control-box">
                ...
                <div id="custom-palette-tools" class="hidden">
                    ...
                    <p>(Click 'X' on swatches above to remove colors)</p>
                    <button type="button" id="eyedropper-button">Pick Color from Image (Eyedropper)</button>
                    <div class="color-input-group">
                        <input type="color" id="custom-color-picker" value="#CCCCCC">
                        <input type="text" id="custom-hex-input" value="#CCCCCC" placeholder="#RRGGBB">
                        <button id="add-color-button" type="button">Add</button>
                    </div>
        ...
        <div id="color-quantizer-canvas-container">
...
- **Custom Color Palettes**: Create and edit your own color schemes
...
- **Multiple Palette Options**: From 1-bit to full color palettes
...
- **Print Design**: Reduce colors for cost-effective printing
- **Web Optimization**: Create smaller, faster-loading images
- **Artistic Effects**: Achieve unique visual styles
- **Color Analysis**: Study color relationships and palettes
