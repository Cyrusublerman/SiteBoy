const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/marching-squares-BVjnU7NB.js","assets/chunk-DtRyYLXJ.js","assets/curve-geometry-BqRX75oR.js","assets/polygon-operations-DwT7bY26.js","assets/index-Dq-NPXX2.js","assets/animation-foundation-CjDnqZPq.js","assets/Text-CdRabE3w.js","assets/foundation-C9ak9BLo.js","assets/index-DLEJXQML.css"])))=>i.map(i=>d[i]);
import{t as e}from"./chunk-DtRyYLXJ.js";import{r as t}from"./index-Dq-NPXX2.js";var n=e({contourSTL:()=>o,exportArtworkSTLs:()=>c,generateBox:()=>i,vectorizePixels:()=>r});function r(e,t,n){let r=[],i=new Set,a=Array(n).fill(null).map(()=>Array(t).fill(!1));for(let r of e){let[e,i]=r.split(`,`).map(Number);i>=0&&i<n&&e>=0&&e<t&&(a[i][e]=!0)}for(let e=0;e<n;e++)for(let o=0;o<t;o++){let s=`${o},${e}`;if(!a[e][o]||i.has(s))continue;let c=1,l=1;for(;o+c<t&&a[e][o+c]&&!i.has(`${o+c},${e}`);)c++;let u=!0;for(;u&&e+l<n;){for(let t=0;t<c;t++)if(!a[e+l][o+t]||i.has(`${o+t},${e+l}`)){u=!1;break}u&&l++}for(let t=0;t<l;t++)for(let n=0;n<c;n++)i.add(`${o+n},${e+t}`);r.push({x:o,y:e,w:c,h:l})}return r}function i(e,t,n,r,i,a){return`facet normal 0 0 -1
  outer loop
    vertex ${e} ${t} ${n}
    vertex ${r} ${t} ${n}
    vertex ${r} ${i} ${n}
...
facet normal 1 0 0
  ...
  endloop
endfacet
`}function a(e,t,n){let r=t+2,i=n+2,a=new Float32Array(r*i);for(let i of e){let[e,o]=i.split(`,`).map(Number);e>=0&&e<t&&o>=0&&o<n&&(a[(o+1)*r+(e+1)]=1)}return{field:a,fieldW:r,fieldH:i}}async function o(e,n,r,i,o,c,l={}){let{simplifyTolerance:u=.3,chaikinIterations:d=2,minContourArea:f=2}=l;if(e.size===0)return``;let[{extractContours:p,simplifyContour:m},{chaikinSmooth:h},{earClipTriangulate:g,polygonArea:_,ensureCCW:v}]=await Promise.all([t(()=>import(`./marching-squares-BVjnU7NB.js`).then(e=>e.o),__vite__mapDeps([0,1])),t(()=>import(`./curve-geometry-BqRX75oR.js`).then(e=>e.o),__vite__mapDeps([2,1])),t(()=>import(`./polygon-operations-DwT7bY26.js`).then(e=>e.o),__vite__mapDeps([3,4,1,5,6,7,8]))]),{field:y,fieldW:b,fieldH:x}=a(e,n,r),S=p(y,b,x,.5,{cellSize:1});if(S.length===0)return[];let C=[];for(let e of S){if(e=e.map(e=>({x:e.x-1,y:r-(e.y-1)})),Math.abs(_(e))<f||(u>0&&e.length>4&&(e=m(e,u)),d>0&&e.length>=3&&(e=h(e,d,!0)),e.length<3))continue;e=v(e);let t=s(e.map(e=>({x:e.x*c,y:e.y*c})),i,o,g);for(let e=0;e<t.length;e++)C.push(t[e])}return C}function s(e,t,n,r){let i=[],a=e.length,o=r(e);for(let[e,t,r]of o)i.push(`facet normal 0 0 1
  outer loop
    vertex ${e.x} ${e.y} ${n}
    vertex ${t.x} ${t.y} ${n}
    vertex ${r.x} ${r.y} ${n}
