import{t as e}from"./foundation-BEfhACXy.js";import{t,zn as n}from"./index-Ciw0oRof.js";import{t as r}from"./tool-base-uvZOXKmx.js";import{t as i}from"./download-CayX61Ew.js";var a=class extends e{constructor(e,n={}){super({componentType:`p5-to-video`},n),this.container=e,this.deps={ComponentLibrary:t,...n},this.p5Code=this.getDefaultCode(),this.isRecording=!1,this.isProcessing=!1,this.ccaptureLoaded=!1,this.tool=null,this.previewFrame=null,this.recordingFrame=null,this.componentInstances=[],this.messageHandler=null,this.render()}getDefaultCode(){return`function setup() {
