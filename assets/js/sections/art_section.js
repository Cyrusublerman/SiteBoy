...
const ArtSection = {
    ...
    // Note: Generative tools moved to tools_section - art section is for curated output only
    pages: [
        '#art',
        '#art/digital',
        '#art/sketches',
    ...
    renderArtIndex() {
        ...
        if (contentContainer) {
            ...
            // Keep internal padding for readability, just fix the position
            if (window.MathematicalFoundation) {
                ...
                console.log(`✅ Applied no-subheader layout for art index: top=${contentTop}px`);
            }
        }
