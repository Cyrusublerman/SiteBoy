// Local copy of reference dithermark shared/models/dither-algorithms.js
// Source: reference/tools/New folder/dithermark-master/dithermark-master/js/shared/models/dither-algorithms.js

import { YLILUOMA_1_ORDERED_MATRIX_MAX_DIMENSIONS } from '../../../../reference/tools/New folder/dithermark-master/dithermark-master/constants.js';
...
const getOrderedDitherPatterns = () => [
    ...
    { title: 'Cross Hatch Horizontal', pattern: 'crossHatchHorizontal', dimensions: 4 },
    { title: 'Cross Hatch Vertical', pattern: 'crossHatchVertical', dimensions: 4 },
    { title: 'Cross Hatch Right', pattern: 'crossHatchRight', dimensions: 4 },
    { title: 'Cross Hatch Left', pattern: 'crossHatchLeft', dimensions: 4 },
    { title: 'Zigzag Horizontal 4×4', pattern: 'zigzagHorizontal', dimensions: 4 },
    { title: 'Zigzag Vertical 4×4', pattern: 'zigzagVertical', dimensions: 4 },
    { title: 'Zigzag Horizontal 8×8', pattern: 'zigzagHorizontal', dimensions: 8 },
    { title: 'Zigzag Vertical 8×8', pattern: 'zigzagVertical', dimensions: 8 },
    { title: 'Zigzag Horizontal 16×16', pattern: 'zigzagHorizontal', dimensions: 16 },
    { title: 'Zigzag Vertical 16×16', pattern: 'zigzagVertical', dimensions: 16 },
    { title: 'Checkerboard', pattern: 'checkerboard', dimensions: 2 },
    { title: 'Cluster', pattern: 'cluster', dimensions: 4 },
    { title: 'Heart 8×8', pattern: 'heart', dimensions: 8 },
    { title: 'Heart 16×16', pattern: 'heart', dimensions: 16 },
    { title: 'Stars', pattern: 'stars', dimensions: 16 },
    { title: 'Smile 8×8', pattern: 'smile', dimensions: 8 },
    { title: 'Smile 16×16', pattern: 'smile', dimensions: 16 },
