            ...
            params: [
                {
                    ...
                    type: 'slider',
                    label: 'Spirals',
                    description: 'Number of unique spiral indices; total drawn = 2× this value (forward + reverse per index).',
                    min: 3,
                    max: 18,
                    step: 1,
                    default: 9
                },
                {
                    ...
                    type: 'slider',
                    label: 'Size',
                    description: 'Base radius scalar from min(canvas width, height).',
                    min: 0.1,
                    max: 0.4,
                    step: 0.01,
                    default: 0.18,
                ...
                },
                {
                    ...
                    type: 'slider',
                    label: 'Major Radius',
                    description: 'Scales major torus radius R = base × this factor.',
                    min: 0.5,
                    max: 2,
                    step: 0.05,
                    default: 1,
                ...
                },
                {
                    ...
                    type: 'slider',
                    label: 'Minor Radius',
                    description: 'Scales tube radius r = base × this factor.',
                    min: 0.5,
                    max: 2,
                    step: 0.05,
                    default: 1,
                ...
                },
                {
                    ...
                    type: 'slider',
                    label: 'Spiral Winds',
                    description: 'Times each spiral winds around the major circle.',
                    min: 1,
                    max: 10,
                    step: 1,
                    default: 4
                ...
                // TOR-03: configurable mesh ring count
                {
                    ...
                    type: 'slider',
                    label: 'Mesh Rings',
                    description: 'Poloidal ring count for the cross-section mesh.',
                    min: 4,
                    max: 72,
                    step: 1,
                    default: 36
            ...
            params: [
                {
                    ...
                    type: 'slider',
                    label: 'View X (deg)',
                    description: 'Camera X-axis tilt in degrees; combined with xRotation at draw time.',
                    min: 0,
                    max: 360,
                    step: 1,
                    default: 30
                },
                {
                    ...
                    type: 'slider',
                    label: 'View Y (deg)',
                    description: 'Camera Y-axis yaw in degrees; applied first in the projection chain.',
                    min: 0,
                    max: 360,
                    step: 1,
                    default: 22.5,
                ...
                },
                {
                    ...
                    type: 'slider',
                    label: 'Cycle Speed',
                    description: 'Frames per animation loop; use in expressions as loop or with frame for timing.',
                    min: 600,
                    max: 7200,
                    step: 60,
                    default: 3600
                },
                {
                    ...
                    description: 'Multiplier on meshRotation at draw time; negative reverses direction.',
                    min: -3,
                    max: 3,
                    step: 0.1,
                    default: 1.0,
                ...
                },
                {
                    ...
                    type: 'slider',
                    label: 'Mesh Rotation',
                    description: 'Toroidal mesh rotation angle in radians; toggle f for expression e.g. frame * TAU / loop.',
                    min: 0,
                    max: 6.283185307,
                    step: 0.001,
                    default: 0,
                ...
                },
                {
                    ...
                    type: 'slider',
                    label: 'Spiral Angle',
                    description: 'Spiral path rotation in radians; toggle f for expression e.g. -frame * TAU / loop.',
                    min: -6.283185307,
                    max: 6.283185307,
                    step: 0.001,
                    default: 0,
                ...
                },
                {
                    ...
                    type: 'slider',
                    label: 'X Rotation',
                    description: 'Frame-driven X-axis offset in radians; toggle f for expression e.g. frame * TAU / loop.',
                    min: 0,
                    max: 6.283185307,
                    step: 0.001,
                    default: 0,
