    ...
    return {
        ...
        infoSections: [
            ...
            },
            {
                ...
                body:    'textarea parameter type not supported by the host: equation input is restricted to predefined dropdown options rather than arbitrary user expressions; the spec intent of free-text equations is architecturally blocked. WAV export (AUDIO-008) is implemented but not UI-accessible: no action button type exists in the generator parameter system and the host export tab has no WAV entry; wavExporter() can be invoked programmatically only. Segmented mode: segmentStartWave (spec range 0–100000) and segmentWaveCount parameters are not exposed; Segmented is currently identical to Oscilloscope. GIF export suppressed: animation type is infinite with no loopFrames. AudioContext may require a user gesture on some browsers (autoplay policy); clicking the Play toggle constitutes the required gesture. safeEquationCompiler uses new Function — blocked by CSPs that prohibit eval-equivalent constructs; Worker-based evaluation is the recommended mitigation (not implemented in this version). wavExporter uses document.createElement for download — a DOM exception to the architecture rule, unavoidable for file export and harmless since it is not currently UI-triggered.'
            },
            {
                heading: 'REFERENCES',
                body:    'Live script: assets/js/tools/generators/scripts/other/wave-equation-synth.gen.js v1.0.0. Archive stub: reference/generators/wave-equation-synth/source/wave-equation-synth.gen.js. Spec: reference/generators/wave-equation-synth/legacy-docs/wave-equation-synth-spec.md. Audit: reference/generators/wave-equation-synth/legacy-docs/wave-equation-synth-audit.md. Registry: assets/js/tools/generators/core/script-registry.js. Host: assets/js/tools/generators/core/generative-tool-host.js. Parameter builder: assets/js/tools/generators/core/parameter-builder.js. Docs pack: blog/docs/pages/tools/generators/wave-equation-synth/. Algorithm sources: additive synthesis (Fourier/Helmholtz), Web Audio API AudioBuffer, oscilloscope polar coordinate mapping, RIFF/WAVE PCM 16-bit format. Modules: AUDIO-004 safeEquationCompiler, AUDIO-005 waveIndexing, AUDIO-006 equationEvaluator, AUDIO-007 audioBufferSource, AUDIO-008 wavExporter, CANVAS-014 oscilloscopeRenderer, CANVAS-015 circularLoopRenderer, CANVAS-016 gifExporter (stubbed), MATH-002 clamp.'
            }
        ],
