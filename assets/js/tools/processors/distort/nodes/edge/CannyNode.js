...
export const CannyNode = createEffectModule({
  ...
  params: {
    ...
    lowThreshold:  { value: 0.1, min: 0.01, max: 0.5, step: 0.01, label: 'LOW THRESH',  tier: 3, driveable: true, unit: '0–1' },
    highThreshold: { value: 0.3, min: 0.05, max: 1,   step: 0.01, label: 'HIGH THRESH', tier: 3, driveable: true, unit: '0–1' }
  },
  apply(src, dst, w, h, p) {
