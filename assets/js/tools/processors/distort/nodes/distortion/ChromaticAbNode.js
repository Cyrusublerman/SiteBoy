...
export const ChromaticAbNode = createEffectModule({
  ...
  params: {
    redShift:  { value: 2,   min: -20, max: 20, step: 0.5,  label: 'RED SHIFT',  tier: 3, driveable: true, unit: 'px' },
    blueShift: { value: -2,  min: -20, max: 20, step: 0.5,  label: 'BLUE SHIFT', tier: 3, driveable: true, unit: 'px' },
