...
export const LuminanceFlowNode = createEffectModule({
  ...
  params: {
    ...
    strokeWeight: { label: 'STROKE W',  min: 0.1, max: 4, step: 0.1, value: 0.7, tier: 3, unit: 'px' },
    resolution:   { label: 'STEP',      min: 1, max: 10,  step: 1,   value: 2,    tier: 4 },
    amplitude:    { label: 'AMPLITUDE', min: 0, max: 80,  step: 1,   value: 15,   tier: 3, unit: 'px', driveable: true },
    lumExp:       { label: 'LUM EXP',   min: 0.2, max: 4, step: 0.1, value: 1,   tier: 4, driveable: true },
    damping:      { label: 'DAMPING',   min: 0.01, max: 1, step: 0.01, value: 0.95, tier: 4 },
    iterations:   { label: 'ITERATIONS', min: 1, max: 20, step: 1,   value: 3,   tier: 4, previewMax: 2 },
    bgBrightness: { label: 'BG LEVEL',  min: 0, max: 255, step: 1,   value: 10,  tier: 4 }
  },
