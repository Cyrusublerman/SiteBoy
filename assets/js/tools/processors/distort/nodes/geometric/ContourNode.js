...
export const ContourNode = createEffectModule({
  ...
  category: 'GEOMETRIC',
  params: {
    levels:      { label: 'LEVELS',     min: 2, max: 32,  step: 1,    value: 8,   tier: 3, driveable: true },
    strokeW:     { label: 'STROKE W',   min: 0.5, max: 4, step: 0.5,  value: 1,   tier: 3, unit: 'px', driveable: true },
    strokeLevel: { label: 'STROKE LVL', min: 0, max: 255, step: 1,   value: 0,   tier: 4, driveable: true },
    blendAmt:    { label: 'BLEND',      min: 0, max: 1,   step: 0.01, value: 0.7, tier: 3, driveable: true }
  },
  apply(src, dst, w, h, p) {
