...
export const TemperatureTintNode = createEffectModule({
  ...
  isLUT: true,
  params: {
    temperature: { value: 0, min: -100, max: 100, step: 1, label: 'TEMPERATURE', tier: 3, driveable: true },
    tint:        { value: 0, min: -100, max: 100, step: 1, label: 'TINT',        tier: 3, driveable: true }
  },
  apply(src, dst, w, h, p) {
