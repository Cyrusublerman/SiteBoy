...
export const GreyscaleNode = createEffectModule({
  ...
  params: {
    wr: { value: 0.299, min: 0, max: 1, step: 0.01, label: 'R WEIGHT', tier: 3 },
    wg: { value: 0.587, min: 0, max: 1, step: 0.01, label: 'G WEIGHT', tier: 3 },
    wb: { value: 0.114, min: 0, max: 1, step: 0.01, label: 'B WEIGHT', tier: 4 }
  },
  apply(src, dst, w, h, p) {
