...
export const RadialRippleNode = createEffectModule({
  ...
  params: {
    ...
    amplitude: { value: 15,  min: 0,   max: 100, step: 0.5, label: 'AMPLITUDE', tier: 3, driveable: true },
    frequency: { value: 10,  min: 0.5, max: 50, step: 0.5,  label: 'FREQUENCY', tier: 3, driveable: true },
    phase:     { value: 0,   min: 0,   max: 6.28, step: 0.01, label: 'PHASE',   tier: 4, driveable: true },
    falloff:   { value: 1,   min: 0,   max: 5,  step: 0.1,  label: 'FALLOFF',   tier: 4 }
  },
