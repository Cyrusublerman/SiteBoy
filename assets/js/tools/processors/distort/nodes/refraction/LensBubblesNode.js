...
export const LensBubblesNode = createEffectModule({
  ...
  params: {
    count:         { value: 5,    min: 1,    max: 30,  step: 1,    label: 'COUNT',      tier: 3, driveable: true, unit: 'n' },
    magnification: { value: 1.5,  min: 0.2,  max: 5,   step: 0.1,  label: 'MAGNIFY',    tier: 3, driveable: true, unit: 'n' },
