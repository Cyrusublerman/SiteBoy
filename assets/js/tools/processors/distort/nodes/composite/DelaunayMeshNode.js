...
export const DelaunayMeshNode = createEffectModule({
  ...
  category: 'COMPOSITE',
  params: {
    pointCount: { label: 'POINTS',   min: 10, max: 2000, step: 10,   value: 200, tier: 3, previewMax: 100 },
    wireWeight: { label: 'WIRE W',   min: 0,  max: 3,    step: 0.25, value: 0.5, tier: 3, unit: 'px' },
    wireLevel:  { label: 'WIRE LVL', min: 0,  max: 255,  step: 1,    value: 40,  tier: 4, driveable: true },
